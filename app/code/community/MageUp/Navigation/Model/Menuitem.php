 ...
 */
class MageUp_Navigation_Model_Menuitem extends Mage_Core_Model_Abstract
{
    ...
    public function saveStoreValues()
    {
        ...
        $storeTableName = $this->getResource()->getTable('mageup_nav/menuitem_store');
        ...
        if ($count) {
            ...
            $write->insert($this->getResource()->getTable('mageup_nav/menuitem_store'), array(
                'entity_id' => $this->getId(),
                'url' => $this->getUrl(),
                'title' => $this->getTitle(),
                'store_id' => $storeId,
