 ...
 */
class MageUp_Navigation_Model_Tree extends Mage_Core_Model_Abstract
{
    public function getTreeNode($node)
    {
        ...
        $item = array();
        if ($node instanceof MageUp_Navigation_Model_Menuitem) {
            // revers mapping
            $mappingArray = MageUp_Navigation_Model_Menuitem::$mapArray;
