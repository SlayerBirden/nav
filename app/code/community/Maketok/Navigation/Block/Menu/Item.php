 ...
 * @method Maketok_Navigation_Block_Menu getMenu
 *
 * @category    Maketok
 ...
 */
class Maketok_Navigation_Block_Menu_Item extends Mage_Core_Block_Template
{
    /**
     * menu item model
    ...
    {
        parent::_construct();
        $this->setTemplate('maketok/navigation/menu/item.phtml');
    }

    /**
     * @param Varien_Data_Tree_Node $item
     * @return Maketok_Navigation_Block_Menu_Item
     */
